...
export const skills = [
    { category: "AI & Automation", items: ["AI Agents", "RAG", "LLM APIs", "n8n"] },
    { category: "Frontend", items: ["React", "Next.js", "TypeScript", "Tailwind CSS"] },
    { category: "Backend", items: ["Node.js", "Express.js"] },
    { category: "Database", items: ["PostgreSQL", "SQL"] },
    { category: "Tools & Workflow", items: ["Git", "GitHub", "VS Code", "Vercel"] },
    { category: "Microsoft & Data", items: ["Excel", "PowerPoint", "Word"] },
];
...
export const projects: Project[] = [
    {
        ...
        customerUrl: "https://ai-customer-agent-beige.vercel.app/w/mntechnique",
