...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50/40"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 text-center lg:text-left space-y-6 animate-fade-in">
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
            ...
            {/* Download CV button — replace /cv.pdf with your actual CV file placed in /public folder */}
            <a
              href="/cv.pdf"
              download
        ...
        <div className="flex-shrink-0 flex flex-col items-center gap-6">
          <div className="relative">
            ...
            <div className="relative w-52 h-52 lg:w-64 lg:h-64 rounded-full border-4 border-white shadow-2xl overflow-hidden">
              {/*
                Photo is loaded from /public/myprofile.png
                Copy your myprofile.png file into the /public folder of your project
              */}
              <img
                src="/myprofile.png"
                alt="Mohammed Alhfidi"
